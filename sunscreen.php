    ...
    <section id="kategori" class="kategori">
      ...
      <div class="row">
        <div class="kategori-card">
          <img
            src="./assets/sunscreen/ss1.jpg"
            alt="serum"
            class="kategori-image"
          />
          <h3 class="merek-kategori">Sunscreen 1</h3>
          <p class="price">IDR 70k</p>
        </div>
        <div class="kategori-card">
          <img
            src="./assets/sunscreen/ss2.jpg"
            alt="serum"
            class="kategori-image"
          />
          <h3 class="merek-kategori">Sunscreen 2</h3>
          <p class="price">IDR 70k</p>
        </div>
        <div class="kategori-card">
          <img
            src="./assets/sunscreen/ss3.jpg"
            alt="serum"
            class="kategori-image"
          />
          <h3 class="merek-kategori">Sunscreen 3</h3>
          <p class="price">IDR 70k</p>
        </div>
        <div class="kategori-card">
          <img src="./assets/serum4.jpg" alt="serum" class="kategori-image" />
          <h3 class="merek-kategori">Sunscreen 4</h3>
          <p class="price">IDR 70k</p>
        </div>
      </div>
    </section>
