    ...
    <section id="kategori" class="kategori">
      ...
      <div class="row">
        <div class="kategori-card">
          <img
            src="./assets/lipcare/lip1.jpg"
            alt="serum"
            class="kategori-image"
          />
          <h3 class="merek-kategori">Lip 1</h3>
          <p class="price">IDR 70k</p>
        </div>
        <div class="kategori-card">
          <img
            src="./assets/lipcare/lip2.jpg"
            alt="serum"
            class="kategori-image"
          />
          <h3 class="merek-kategori">Lip 2</h3>
          <p class="price">IDR 70k</p>
        </div>
        <div class="kategori-card">
          <img
            src="./assets/lipcare/lip3.jpg"
            alt="serum"
            class="kategori-image"
          />
          <h3 class="merek-kategori">Lip 3</h3>
          <p class="price">IDR 70k</p>
        </div>
        <div class="kategori-card">
          <img
            src="./assets/lipcare/lip4.jpg"
            alt="serum"
            class="kategori-image"
          />
          <h3 class="merek-kategori">Lip 4</h3>
          <p class="price">IDR 70k</p>
        </div>
        <div class="kategori-card">
          <img
            src="./assets/lipcare/lip5.jpg"
            alt="serum"
            class="kategori-image"
          />
          <h3 class="merek-kategori">Lip 5</h3>
          <p class="price">IDR 70k</p>
        </div>
      </div>
    </section>
