    ...
    <section id="kategori" class="kategori">
      ...
      <div class="row">
        <div class="kategori-card">
          <img
            src="./assets/moist/moist1.jpg"
            alt="serum"
            class="kategori-image"
          />
          <h3 class="merek-kategori">Moisturizer 1</h3>
          <p class="price">IDR 70k</p>
        </div>
        <div class="kategori-card">
          <img
            src="./assets/moist/moist2.jpg"
            alt="serum"
            class="kategori-image"
          />
          <h3 class="merek-kategori">Moisturizer 2</h3>
          <p class="price">IDR 70k</p>
        </div>
        <div class="kategori-card">
          <img
            src="./assets/moist/moist3.jpg"
            alt="serum"
            class="kategori-image"
          />
          <h3 class="merek-kategori">Moisturizer 3</h3>
          <p class="price">IDR 70k</p>
        </div>
        <div class="kategori-card">
          <img src="./assets/moist/moist3.jpg" alt="serum" class="kategori-image" />
          <h3 class="merek-kategori">Moisturizer 4</h3>
          <p class="price">IDR 70k</p>
        </div>
      </div>
    </section>
